...
| `5` | `VALIDATION_ERROR` — file not found, empty, unresolvable path, review directory creation failure, plan file write failure, preexisting-content tamper detection, or quarantine persistence/truncation failure |
